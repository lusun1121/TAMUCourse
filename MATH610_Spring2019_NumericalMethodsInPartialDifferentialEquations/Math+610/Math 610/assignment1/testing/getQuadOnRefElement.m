...
%
% return a structure containing the quadrature for a bulk 1D inteval
% on reference element, Khat = [0,1].  The values are given with 32
% decimals of accuracy but they are then stored as double which has only
% 16 decimals of accuracy.
%
