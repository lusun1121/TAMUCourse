...
for i=1:79
    ...
    uh2=(1-5*tau)*uh1-tau*M\(S*uh1)+tau*M\RHS;
    ...
    if (i==5 || i==10)
     ...
     [localL2sqrd, localH1sqrd] = computeLocalErrors(vertices, uh1(dofIndices), u_exact, grad_u_exact,ti,Quad_Error, FE_at_Quad_Error, p);
