...
%
%
function [uh]=mainFEM1D_Dirichlet(num_elements,choose)
...
switch(problem_case)
    ...
    case 0
        ...
        xlabel('x');
        ylabel('solution');
        title({'1D Laplacian with Dirichlet BC',['homework ',...
            num2str(problem_case)],['N=',num2str(DoFHandler.n_dofs)]});
            %['S=',num2str(S),',','N=',num2str(DoFHandler.n_dofs)]});
        legend('uh', 'uexact');
%        saveas(lmbd, ['\\blender\homes\l\u\lusun8825\nt\AccountSettings\Desktop\sunlu\result\',...
%            'hm',num2str(problem_case),'_N',num2str(DoFHandler.n_dofs),'_sl.png'],'png');
