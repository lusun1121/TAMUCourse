...
function [local_L2_error_sqrd, local_H1_error_sqrd] = computeLocalErrorsH1(localvertices, uh_at_localdofs, u_exact, grad_u_exact, Quad, FE_at_Quad, p)
...
%affine map info
mat_B = (localvertices(3,:) - localvertices(1,:))'; %[(dim)x(dim)]
det_B = abs(det(mat_B));    
inv_B = 1/mat_B;
