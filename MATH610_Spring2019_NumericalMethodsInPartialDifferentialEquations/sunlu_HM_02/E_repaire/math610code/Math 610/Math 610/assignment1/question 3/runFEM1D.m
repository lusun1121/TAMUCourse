function [mesh_size, n_dofs, L2error, H1error, Linferror] = runFEM1D(n_elements,p,quad_degree, bPlotSolutions,u_exact,grad_u_exact)
...
T = constructTriangulation1D1(L, n_elements);
